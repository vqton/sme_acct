...
describe('LedgerTaxExtractionService', () => {
  ...
  beforeAll(() => {
    ...
    const accts = [
      { id: 0, companyId, accountNumber: '1331', name: 'Thuế GTGT được khấu trừ', category: 3, nature: 1, type: 2, isActive: true, isSystem: true, allowTransactions: true, openingDebit: 0, openingCredit: 0, debitAmount: 0, creditAmount: 0, closingDebit: 0, closingCredit: 0, currency: 'VND', createdAt: new Date() },
      { id: 0, companyId, accountNumber: '33311', name: 'Thuế GTGT đầu ra', category: 6, nature: 2, type: 2, isActive: true, isSystem: true, allowTransactions: true, openingDebit: 0, openingCredit: 0, debitAmount: 0, creditAmount: 0, closingDebit: 0, closingCredit: 0, currency: 'VND', createdAt: new Date() },
      { id: 0, companyId, accountNumber: '5111', name: 'Doanh thu bán hàng hóa', category: 7, nature: 2, type: 2, isActive: true, isSystem: true, allowTransactions: true, openingDebit: 0, openingCredit: 0, debitAmount: 0, creditAmount: 0, closingDebit: 0, closingCredit: 0, currency: 'VND', createdAt: new Date() },
      { id: 0, companyId, accountNumber: '632', name: 'Giá vốn hàng bán', category: 11, nature: 1, type: 1, isActive: true, isSystem: true, allowTransactions: true, openingDebit: 0, openingCredit: 0, debitAmount: 0, creditAmount: 0, closingDebit: 0, closingCredit: 0, currency: 'VND', createdAt: new Date() },
      { id: 0, companyId, accountNumber: '6421', name: 'Chi phí nhân viên', category: 11, nature: 1, type: 2, isActive: true, isSystem: true, allowTransactions: true, openingDebit: 0, openingCredit: 0, debitAmount: 0, creditAmount: 0, closingDebit: 0, closingCredit: 0, currency: 'VND', createdAt: new Date() },
      { id: 0, companyId, accountNumber: '3334', name: 'Thuế TNDN phải nộp', category: 6, nature: 2, type: 2, isActive: true, isSystem: true, allowTransactions: true, openingDebit: 0, openingCredit: 0, debitAmount: 0, creditAmount: 0, closingDebit: 0, closingCredit: 0, currency: 'VND', createdAt: new Date() },
    ];
