...
const SYSTEM_ROLES: RoleDefinition[] = [
  ...
  },
  {
    ...
    permissions: ['company:read', 'company:create', 'company:update', 'user:read', 'report:read', 'transaction:approve', 'settings:manage', 'audit:view'] as const,
    isSystemRole: false,
  },
  {
    id: 'ke-toan-tong-hop',
    ...
    permissions: ['company:read', 'company:create', 'company:update', 'user:read', 'report:read'] as const,
    isSystemRole: false,
  },
  {
    id: 'ke-toan-thue',
